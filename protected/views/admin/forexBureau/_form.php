...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'forex_bureau_name'); ?>
		<?php echo $form->textField($model,'forex_bureau_name',array('size'=>40,'maxlength'=>40)); ?>
		<?php echo $form->error($model,'forex_bureau_name'); ?>
	</div>
