...
class ChargeController extends AdminEndController
{
	/**
	...
	{
		$data=ChargeName::model()->findAll('category=:category', 
					  array(':category'=>(int) $_POST['Charge']['category']));
	 	//$cat_id = 4;
	 	//$data=ChargeName::model()->findAll('category = '. $cat_id) ;
